![docker image](https://github.com/marzieh-saeedimasine/nomad-distro-oasis/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/marzieh-saeedimasine/nomad-distro-oasis.git
    cd nomad-distro-oasis
    ```

    or

    ```sh
    curl-L -o nomad-distro-oasis.zip "https://github.com/marzieh-saeedimasine/nomad-distro-oasis/archive/main.zip"
    unzip nomad-distro-oasis.zip
    cd nomad-distro-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/marzieh-saeedimasine/nomad-distro-oasis:main` for the services
...
```sh
docker pull ghcr.io/marzieh-saeedimasine/nomad-distro-oasis/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/marzieh-saeedimasine/nomad-distro-oasis/manifests/main": unauthorized`
